...
export const ambientVsLofiDeepWork: BlogPost = {
  slug: "why-ambient-music-works-better-than-lofi-for-deep-work",
  title: "Why Ambient Music Works Better Than Lofi for Deep Work",
  titleDe: "Warum Ambient-Musik besser funktioniert als Lofi für Deep Work",
  description:
    "Lofi beats are everywhere. But when you need to write code, analyze data, or solve complex problems? Ambient music wins. Here's the science behind why—and how to choose the right sound for your deepest work.",
  descriptionDe:
