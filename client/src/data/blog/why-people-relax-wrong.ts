...
export const whyPeopleRelaxWrong: BlogPost = {
  slug: 'why-most-people-relax-wrong-how-music-can-fix-it',
  title: 'Why Most People Relax Wrong (And How Music Can Fix It)',
  titleDe: 'Warum die meisten Menschen falsch entspannen (und wie Musik das beheben kann)',
  description: 'You collapse on the couch, open Netflix, and think you\'re relaxing. Your cortisol levels disagree. Discover the science of active relaxation and why music is your nervous system\'s best friend.',
  descriptionDe: 'Du lässt dich auf die Couch fallen, öffnest Netflix und denkst, du entspannst. Dein Cortisol-Spiegel sieht das anders. Entdecke die Wissenschaft der aktiven Entspannung und warum Musik der beste Freund deines Nervensystems ist.',
  category: 'relax',
...
Your cortisol levels will thank you.`,
  contentDe: `Du lässt dich auf die Couch fallen, öffnest Netflix und denkst, du entspannst. Dein Cortisol-Spiegel sieht das anders.
