...
export const morningCoffeeJazzRitual: BlogPost = {
  slug: "morning-coffee-jazz-ritual-metal-guitarist-stress-relief",
  title: "The Metal Guitarist Who Created His Own Stress Relief: Morning Coffee Jazz Radio",
  titleDe: "Der Metal-Gitarrist, der sein eigenes Stress-Relief erschuf: Morning Coffee Jazz Radio",
  description:
    "I can shred John Petrucci solos. But when I need to think clearly? I put on jazz and make coffee. Here's why a metal guitarist created his own morning coffee jazz videos—and why this ritual might change your mornings too.",
  descriptionDe:
    "Ich kann John Petrucci Solos shredden. Aber wenn ich klar denken muss? Dann höre ich Jazz und mache Kaffee. Warum ein Metal-Gitarrist seine eigenen Morning Coffee Jazz Videos kreiert hat—und warum dieses Ritual auch deine Morgen verändern könnte.",
...
<div style="margin: 2rem 0; text-align: center;">
  <img src="/images/blog/joachim-guitar.webp" alt="Joachim playing guitar in his studio" style="max-width: 100%; border-radius: 8px; margin-bottom: 1rem;" />
...
That's how [JazzSphere Radio](https://www.youtube.com/@JazzSphereRadio) was born.
...
- Boil water
- Set up French press
- While it's brewing, I put on one of my [Morning Coffee Jazz videos](https://youtu.be/ZaxoVb4Y9h8)
...
[The Perfect Coffee Jazz for a Cozy Morning](https://youtu.be/ZaxoVb4Y9h8) - This is my go-to. 2+ hours of smooth jazz, cozy visuals, perfect for that first cup of coffee.

You can find more on [JazzSphere Radio](https://www.youtube.com/@JazzSphereRadio), where I keep creating these morning soundscapes.
...
So wurde [JazzSphere Radio](https://www.youtube.com/@JazzSphereRadio) geboren.
...
- Während es brüht, lege ich eines meiner [Morning Coffee Jazz Videos](https://youtu.be/ZaxoVb4Y9h8) auf
...
[The Perfect Coffee Jazz for a Cozy Morning](https://youtu.be/ZaxoVb4Y9h8) - Das ist mein Go-to. 2+ Stunden Smooth Jazz, gemütliche Visuals, perfekt für die erste Tasse Kaffee.

Du findest mehr auf [JazzSphere Radio](https://www.youtube.com/@JazzSphereRadio), wo ich weiter diese Morning Soundscapes kreiere.
