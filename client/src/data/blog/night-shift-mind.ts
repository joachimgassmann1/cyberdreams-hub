...
export const nightShiftMind: BlogPost = {
  ...
  titleDe: "Der Nachtschicht-Mind: Warum späte Abendstunden tieferen Fokus und Kreativität freisetzen",
  ...
  descriptionDe: "Entdecke, warum die späten Abendstunden optimale Bedingungen für tiefen Fokus, kreatives Denken und Produktivität schaffen. Erkunde die Psychologie der Nachtarbeit und wie Dunkelheit die Konzentration verstärkt.",
