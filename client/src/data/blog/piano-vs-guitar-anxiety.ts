...
export const pianoVsGuitarAnxiety: BlogPost = {
  slug: 'piano-vs-guitar-anxiety-relief-trained-pianist-verdict',
  title: 'Piano vs Guitar for Anxiety Relief: Which Works Better? (A Trained Pianist\'s Surprising Answer)',
  ...
  readingTime: 11,
  readingTimeDe: 11,
  content: `Last Tuesday, I had a panic attack in the middle of a grocery store. Nothing dramatic triggered it. I was just standing in the cereal aisle when my heart started racing, my hands went numb, and suddenly I couldn't remember why I was there or how to get out.
...
If you want to experiment with piano music for anxiety relief, start with simple ambient piano rather than complex classical pieces. Look for music with minimal harmonic movement, gentle dynamics, and a tempo around 60-70 beats per minute. [Piano Lounge – Relaxing Piano Music](https://www.youtube.com/playlist?list=PLN4PfrJkmWYDNw_bliOLTCsr3w9sAA4w0) is an excellent starting point.
...
That's what really matters.`,
  contentDe: `Letzten Dienstag hatte ich eine Panikattacke mitten im Supermarkt. Nichts Dramatisches hat sie ausgelöst. Ich stand einfach nur im Müsli-Gang, als mein Herz zu rasen begann, meine Hände taub wurden und ich plötzlich nicht mehr wusste, warum ich dort war oder wie ich rauskommen sollte.
