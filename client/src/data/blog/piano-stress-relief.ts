...
export const pianoStressRelief: BlogPost = {
  ...
  readingTime: 9,
  readingTimeDe: 9,
  content: `I spent 10 years learning classical piano. Beethoven sonatas. Chopin nocturnes. Bach fugues. The whole conservatory repertoire. My fingers can navigate through complex harmonies and intricate passages that most people would consider impossible.
...
Because sometimes, the most powerful music is the simplest. And sometimes, the best use of 10 years of classical training is knowing when to ignore everything you learned.`,
  contentDe: `Ich habe 10 Jahre lang klassisches Klavier gelernt. Beethoven-Sonaten. Chopin-Nocturnes. Bach-Fugen. Das komplette Konservatoriums-Repertoire. Meine Finger können durch komplexe Harmonien und komplizierte Passagen navigieren, die die meisten Menschen für unmöglich halten würden.
