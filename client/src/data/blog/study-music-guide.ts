...
export const studyMusicGuide: BlogPost = {
  slug: "study-music-guide-what-science-says-works",
  title: "The Ultimate Study Music Guide: What Science Says Actually Works",
  titleDe: "Der ultimative Study Music Guide: Was laut Wissenschaft wirklich funktioniert",
  description:
...
And if you want to explore what I've found works best, check out our [Deep Focus Sphere channel](https://www.youtube.com/@DeepFocusSphere67) for soundscapes designed specifically for different types of mental work. We've spent years refining these based on feedback from students just like you.
...
Und wenn du erkunden möchtest, was ich als am besten funktionierend gefunden habe, schau dir unseren [Deep Focus Sphere Kanal](https://www.youtube.com/@DeepFocusSphere67) an für Soundscapes, die speziell für verschiedene Arten mentaler Arbeit designed sind. Wir haben Jahre damit verbracht, diese basierend auf Feedback von Studenten wie dir zu verfeinern.
