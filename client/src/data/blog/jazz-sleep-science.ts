...
const jazzSleepScience: BlogPost = {
  slug: 'science-jazz-sleep-smooth-jazz-better-white-noise',
  title: 'The Science of Jazz for Sleep: Why Smooth Jazz Works Better Than White Noise',
  titleDe: 'Die Wissenschaft von Jazz zum Einschlafen: Warum Smooth Jazz besser funktioniert als weißes Rauschen',
  description: 'White noise might mask sound, but smooth jazz does something far more interesting: it synchronizes with your breathing, lowers your heart rate, and guides your nervous system into deep relaxation. Here\'s why your brain prefers Chet Baker over static.',
  descriptionDe: 'Weißes Rauschen mag Geräusche überdecken, aber Smooth Jazz tut etwas viel Interessanteres: Er synchronisiert sich mit deiner Atmung, senkt deine Herzfrequenz und führt dein Nervensystem in tiefe Entspannung. Hier erfährst du, warum dein Gehirn Chet Baker dem Rauschen vorzieht.',
  content: `
...
This is why [JazzSphere Radio](https://www.youtube.com/@JazzSphereRadio) works so well for evening wind-down. The tempo never accelerates. The rhythm never surprises you. It just keeps breathing, and your body follows.
...
Now my evening routine looks like this. I dim the lights around nine PM. I put on [JazzSphere Radio](https://www.youtube.com/@JazzSphereRadio). I let the trumpet and piano wash over the room. I don't focus on the music. I just let it exist in the background, breathing with me, slowing me down.
...
Start with [JazzSphere Radio](https://www.youtube.com/@JazzSphereRadio). Let it play in the background while you wind down. Don't focus on it. Don't try to appreciate it. Just let it exist in the room, shaping the acoustic space, guiding your nervous system.
...
Deshalb funktioniert [JazzSphere Radio](https://www.youtube.com/@JazzSphereRadio) so gut zum abendlichen Herunterfahren. Das Tempo beschleunigt nie. Der Rhythmus überrascht dich nie. Er atmet einfach weiter, und dein Körper folgt.
...
Jetzt sieht meine Abendroutine so aus. Ich dimme die Lichter gegen 21 Uhr. Ich schalte [JazzSphere Radio](https://www.youtube.com/@JazzSphereRadio) ein. Ich lasse die Trompete und das Klavier über den Raum schweben. Ich konzentriere mich nicht auf die Musik. Ich lasse sie einfach im Hintergrund existieren, mit mir atmen, mich verlangsamen.
...
Beginne mit [JazzSphere Radio](https://www.youtube.com/@JazzSphereRadio). Lass es im Hintergrund laufen, während du herunterkommst. Konzentriere dich nicht darauf. Versuche nicht, es zu schätzen. Lass es einfach im Raum existieren, den akustischen Raum formen, dein Nervensystem führen.
