...
OPENAI_API_KEY = "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"
...
def analyze_wine():
    try:
        ...
        return jsonify({"error": f"JSON-Parse-Fehler: {str(e)}", "raw": raw}), 500
